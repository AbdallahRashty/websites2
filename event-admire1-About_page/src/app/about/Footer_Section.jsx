        ...
        <>
            <footer>
                <section className='box1'>
                    <img className='iimg1' src={logo1.src}/>
                ...
                <section className='flexx'>
                    ...
                    <section className='box3'>
                        ...
                        <div className='flexx2'>
                            <img className='iimg2' src={logo2.src} alt="visa" />
                            <img className='iimg3' src={logo3.src} alt="masterpass" />
                        </div>
                    </section>
                </section>
                <section className='downpart'>
                    ...
                    <div className='imgcounta'>
                        <img className='iimg4' src={logo4.src}/>
                    </div>
                    <div className='lower'>
